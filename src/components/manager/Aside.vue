<template>
  <el-menu text-color="#fff"
    ...
    <div style="height: 60px;line-height: 80px;text-align: center">
      <img src="../../assets/logo/logo1.png" alt="" style="width: 20px;position: relative;top: 5px;margin-right: 5px;">
      <b style="color: white;font-size: 20px">{{hotelName}}</b>
    </div>
    <el-menu-item index="/manager/room" style="margin-top: 5px">
      <template slot="title"><i class="el-icon-message"></i><span style="font-size: 16px">房间基本信息</span></template>
    </el-menu-item>
    <el-menu-item index="/manager/roomType" style="margin-top: 5px">
    ...
    <el-menu-item index="/manager/analyse">
